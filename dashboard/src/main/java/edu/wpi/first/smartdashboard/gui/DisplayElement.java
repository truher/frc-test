...
public abstract class DisplayElement extends JPanel implements PropertyHolder {
   ...
   * <p>
   * <p>An obstruction is any object which the SmartDashboard should automatically try to avoid
   * when
   * placing new {@link DisplayElement DisplayElements}. Pretty much everything is an obstruction
   * except for {@link edu.wpi.first.smartdashboard.gui.elements.Image Images} because images will
   * sometimes be used for background effect, in which case it is fine if a new {@link
   * DisplayElement} spawns over it.</p>
   *
