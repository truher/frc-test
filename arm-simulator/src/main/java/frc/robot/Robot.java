...
public class Robot extends TimedRobot {
  ...
  private NetworkTableEntry m_myEntry;
  private NetworkTableEntry m_myCounterEntry;
  private int m_myCounter = 0;

  @Override
  public void robotInit() {
    NetworkTableInstance inst = NetworkTableInstance.getDefault();
    NetworkTable table = inst.getTable("TheTable");
    m_myEntry = table.getEntry("MyEntry");
    m_myCounterEntry = table.getEntry("MyCounter");
  ...
  public void teleopPeriodic() {
    m_myCounter += 1;
    m_myCounterEntry.setNumber(m_myCounter);
    m_myEntry.setDouble(Math.sin(m_myCounter/100));
