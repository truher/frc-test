...
/**
 * include estimateAffine3d from 4.6
 */
public class MyCalib3d {
     ...
     *        vector and \f$s\f$ is a
     *        scalar size value. This is an implementation of the algorithm by
     *        Umeyama \cite umeyama1991least .
     *        The estimated affine transform has a homogeneous scale which is a
     *        subclass of affine
     *        transformations with 7 degrees of freedom. The paired point sets need
     *        to comprise at least 3
     *        points each.
     * @param src            First input 3D point set.
     * @param dst            Second input 3D point set.
     * @param scale          If null is passed, the scale parameter c will be
     *                       assumed to be 1.0.
     *                       Else the pointed-to variable will be set to the optimal
     *                       scale. [NOTE the value
     *                       is obviously not returned in java]
     * @param force_rotation If true, the returned rotation will never be a
     *                       reflection.
     *                       This might be unwanted, e.g. when optimizing a
     *                       transform between a right- and a
